...
ACLOCAL = ${SHELL} /root/avahi-0.6.31/missing --run aclocal-1.11
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/avahi-0.6.31/missing --run autoconf
AUTOHEADER = ${SHELL} /root/avahi-0.6.31/missing --run autoheader
AUTOMAKE = ${SHELL} /root/avahi-0.6.31/missing --run automake-1.11
...
DX_DVIPS = 
DX_EGREP = 
DX_ENV =  SRCDIR='.' PROJECT='avahi' DOCDIR='doxygen' VERSION='0.6.31' HAVE_DOT='NO' GENERATE_MAN='NO' GENERATE_RTF='NO' GENERATE_XML='NO' GENERATE_HTMLHELP='NO' GENERATE_CHI='NO' GENERATE_HTML='NO' GENERATE_LATEX='NO'
DX_FLAG_chi = 0
DX_FLAG_chm = 0
DX_FLAG_doc = 0
DX_FLAG_dot = 0
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/avahi-0.6.31/missing --run makeinfo
MANIFEST_TOOL = :
MCS = 
MDASSEMBLER = 
MKDIR_P = /bin/mkdir -p
...
XML_LIBS = -lexpat
abs_builddir = /root/avahi-0.6.31
abs_srcdir = /root/avahi-0.6.31
abs_top_builddir = /root/avahi-0.6.31
abs_top_srcdir = /root/avahi-0.6.31
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/avahi-0.6.31/install-sh
interfacesdir = 
